...
import { AttachmentList, Banner, Card, Modal, PriorityBadge, Spinner, StatusBadge, waitingLabel } from "../components/ui";
  ...
  return (
    <Modal open onClose={onClose} title={`Обращение #${id}`}>
      <div className="space-y-4">
        ...
        {t.attachments?.length > 0 && <AttachmentList attachments={t.attachments} thumb="h-16 w-16" />}
